class OrderBuyer
  ...
  def save
    ...
    Buyer.create(order_id: order.id, postal_code: postal_code, prefecture: prefecture, city: city, block: block, building_name: building_name, phone_number: phone_number)
  end
end